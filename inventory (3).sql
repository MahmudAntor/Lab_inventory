...
INSERT INTO `customers` (`Customer_Id`, `Name`, `Contact_no`, `payments`) VALUES
(1, 'Sakura', 12357639, 0),
(2, 'Jui', 75637692, 0),
(3, 'Antor', 347634923, 0),
(4, 'Maisha', 74363002, 0),
...
(6, 'Apple', 60, '2017-10-10', 'Shatabdi'),
(7, 'Garlic', 60, '2017-10-10', 'Ratul'),
...
(102, 'potato', 50, 150, '2017-11-03', 2, '-', '-'),
...
--
ALTER TABLE `lot_details`
  MODIFY `Lot_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
